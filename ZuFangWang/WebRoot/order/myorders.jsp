...
<body>
	<div class="bd">
		...
		&nbsp&nbsp<a
			href="${pageContext.request.contextPath}/main/zukemain.jsp">主页</a>
			...
			<table style="width:80%" align="center" border="1px solid black">
				...
				<s:iterator value="#session.OrderList">
					<tr align="center">
						...
						<td id="intime"><s:property value="in_time" /></td>
						<td id="outtime"><s:property value="out_time" /></td>
						<td><s:property value="out_time-in_time" /></td>
