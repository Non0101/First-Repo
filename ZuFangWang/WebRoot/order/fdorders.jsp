...
<body>
	<div class="bd">
		<h1 class="huanying" align="center">
			尊敬的 <font color="green">房东</font><font color="red"> <s:property
					value="#session.yonghuming" /></font>以下是您所有订单信息
		</h1>
		您还可以去往
		&nbsp&nbsp<a
			href="${pageContext.request.contextPath}/common/fdpersonalcenter.jsp">个人中心</a>
		&nbsp&nbsp<a
		...
		<div class="middle">
			<table style="width:80%" align="center" border="1px solid black">
				...
				<s:iterator value="#session.fdOrderList">
					<tr align="center">
